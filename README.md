...
You can update SIGNALFX_ENDPOINT_URL to send spans directly to the SignalFx backend. Refer step 2 above (locate the ingest endpoint) to figure out the SignalFx ingest URL.
